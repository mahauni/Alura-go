...
func TestEditaUmAlunoHandler(t *testing.T) {
	...
	aluno := models.Aluno{Nome: "Aluno Teste", CPF: "42042042069", RG: "696969420"}
	...
	assert.Equal(t, "42042042069", alunoMockAtualizado.CPF)
	assert.Equal(t, "696969420", alunoMockAtualizado.RG)
